...
export type ApiServiceInterface = {
  getHistoricalUsers: (startDate: string, mapBounds: MapBounds, maxUsers: number, activityFilter?: ActivityFilter) => Promise<AxiosResponse<UsersApiResponse>>;
  getActivityStats: (startDate?: string, top?: number) => Promise<AxiosResponse<ActivityStatsApiResponse>>;
